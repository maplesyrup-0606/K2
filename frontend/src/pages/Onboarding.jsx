...
export default function Onboarding({ user, onComplete }) {
  ...
  return (
    <div className="min-h-screen bg-stone-50 dark:bg-stone-950 flex flex-col items-center justify-center p-6">
      <form
        onSubmit={submit}
        className="w-full max-w-md bg-white dark:bg-stone-900 rounded-2xl border border-stone-200 dark:border-stone-800 p-6 shadow-sm"
      >
        ...
        <input
          ...
          required
          autoFocus
          className="mt-5 w-full rounded-lg border border-stone-300 dark:border-stone-700 px-3 py-2 text-stone-900 dark:text-stone-100 focus:outline-none focus:ring-2 focus:ring-stone-900 focus:border-transparent"
        />
